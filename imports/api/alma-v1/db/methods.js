        ...
        if (page == "fixedAssets") {
          ...
          for (let index = 0; index < assets.length; index++) {
            ...
            for (let index = 0; index < documentAssets.length; index++) {
              ...
              if (y.datePublish.toString() == date.toString()) {
                AssetDocuments.update({ _id: y._id }, {
                  $set: {
                    datePublish: null
                  }
                })
          ...
          for (let index = 0; index < organizationDocument.length; index++) {
            ...
            if (x.dateExpired.toString() == date.toString()) {
              OrganizationDocuments.update({ _id: x._id }, {
                $set: {
                  dateExpired: null
                }
              });
          ...
          for (let index = 0; index < listNews.length; index++) {
            ...
            if (x.publishDate.toString() == date.toString()) {
              ...
              News.update({ _id: new Meteor.Collection.ObjectID(id) }, {
                $set: {
                  publishDate: null
                }
              });
          ...
          for (let index = 0; index < webinarList.length; index++) {
            ...
            if (x.webinarDate.toString() == date.toString()) {
              const id = x._id.toHexString()
              Webinar.update({ _id: new Meteor.Collection.ObjectID(id) }, {
                $set: {
                  webinarDate: null
                }
              });
          ...
          for (let index = 0; index < eventList.length; index++) {
            ...
            if (x.date.toString() == date.toString()) {
              Events.update({ _id: new Meteor.Collection.ObjectID(id) }, {
                $set: {
                  date: null
                }
              })
          ...
          for (let index = 0; index < slideList.length; index++) {
            ...
            if (x.publishDate.toString() == date.toString()) {
              const id = x._id.toHexString()
              Slideshows.update({ _id: new Meteor.Collection.ObjectID(id) }, {
                $set: {
                  publishDate: null
                }
              });
          ...
          for (let index = 0; index < jubeliumList.length; index++) {
            ...
            if (x.publishDate.toString() == date.toString()) {
              const id = x._id.toHexString()
              Jubileum.update({ _id: new Meteor.Collection.ObjectID(id) }, {
                $set: {
                  publishDate: null
                }
              });
          ...
          for (let index = 0; index < doaList.length; index++) {
            ...
            if (x.publishDate.toString() == date.toString()) {
              const id = x._id.toHexString()
              Prayers.update({ _id: new Meteor.Collection.ObjectID(id) }, {
                $set: {
                  publishDate: null
                }
              });
          ...
          for (let index = 0; index < laguList.length; index++) {
            ...
            if (x.publishDate.toString() == date.toString()) {
              const id = x._id.toHexString()
              Songs.update({ _id: new Meteor.Collection.ObjectID(id) }, {
                $set: {
                  publishDate: null
                }
              });
